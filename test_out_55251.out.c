...
z_closure_T make_adder(int32_t i);
...
int32_t _lambda_0(void* _ctx, int32_t input) {
    struct Lambda_0_Ctx* ctx = (struct Lambda_0_Ctx*)_ctx;

#line 10 "tests/language/functions/test_closure_generic.zc"
    return (input + ctx->i);
}
...
#line 15 "tests/language/functions/test_closure_generic.zc"
    z_closure_T add3 = 
#line 15 "tests/language/functions/test_closure_generic.zc"
make_adder(3);

#line 16 "tests/language/functions/test_closure_generic.zc"
__zenc_assert((
#line 16 "tests/language/functions/test_closure_generic.zc"
({ z_closure_T _c = add3; ((int32_t (*)(void*, int32_t))_c.func)(_c.ctx, 10); }) == 13), "Closure with generic RAII failed");

#line 18 "tests/language/functions/test_closure_generic.zc"
    z_closure_T add5 = 
#line 18 "tests/language/functions/test_closure_generic.zc"
make_adder(5);

#line 19 "tests/language/functions/test_closure_generic.zc"
__zenc_assert((
#line 19 "tests/language/functions/test_closure_generic.zc"
({ z_closure_T _c = add5; ((int32_t (*)(void*, int32_t))_c.func)(_c.ctx, 10); }) == 15), "Closure with generic RAII (second call) failed");
    }
}
...
#line 5 "tests/language/functions/test_closure_generic.zc"

z_closure_T make_adder(int32_t i)
{
    {

#line 7 "tests/language/functions/test_closure_generic.zc"
    int __z_drop_flag__ = 1; Vec__int32_t _ = 
#line 7 "tests/language/functions/test_closure_generic.zc"
Vec__int32_t__new();

#line 9 "tests/language/functions/test_closure_generic.zc"
    { z_closure_T _z_ret = ({ struct Lambda_0_Ctx *_z_ctx_0 = malloc(sizeof(struct Lambda_0_Ctx));
*(int32_t*)(&_z_ctx_0->i) = i;
(z_closure_T){.func = _lambda_0, .ctx = _z_ctx_0, .drop = _lambda_0_drop}; }); 
#line 7 "tests/language/functions/test_closure_generic.zc"
    if (__z_drop_flag__) Vec__int32_t__Drop__glue(&_);
return _z_ret; }
